...
function getFilterLimit(filter) {
  ...
  return Math.min(
    Math.max(0, (_a = filter.limit) != null ? _a : Infinity),
    (_c = (_b = filter.ids) == null ? void 0 : _b.length) != null ? _c : Infinity,
    ((_d = filter.authors) == null ? void 0 : _d.length) && ((_e = filter.kinds) == null ? void 0 : _e.every((kind) => isReplaceableKind(kind))) ? filter.authors.length * filter.kinds.length : Infinity,
    ((_f = filter.authors) == null ? void 0 : _f.length) && ((_g = filter.kinds) == null ? void 0 : _g.every((kind) => isAddressableKind(kind))) && ((_h = filter["#d"]) == null ? void 0 : _h.length) ? filter.authors.length * filter.kinds.length * filter["#d"].length : Infinity
  );
}
