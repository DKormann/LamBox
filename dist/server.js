...
var server = http.createServer(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        req.on('end', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request_data, event_1, resp, dat, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request_data = Buffer.concat(chunks).toString();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!request_data) {
                        ...
                        event_1 = JSON.parse(request_data);
                        if (!auth_1.auth.checkEvent(event_1)) return [3 /*break*/, 3];
                        return [4 /*yield*/, (0, database_1.acceptEvent)(event_1)];
                    case 2:
                        resp = _a.sent();
                        dat = JSON.stringify(resp);
                        res.write(dat);
                        res.end();
                        return [3 /*break*/, 4];
                    case 3:
